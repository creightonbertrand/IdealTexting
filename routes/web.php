...
Route::get('sms/send-sms-user','SMSController@sendBulkSMSU');
...
Route::post('sms/post-bulk-sms-user','SMSController@postSendBulkSMSU');
...
// SMS Reply Templates
//======================================================================
Route::get('sms/sms-reply-templates','SMSController@smsReplyTemplates');
Route::get('sms/create-sms-reply-template','SMSController@createSmsReplyTemplate');
Route::post('sms/post-sms-reply-template','SMSController@postSmsReplyTemplate');
Route::get('sms/manage-sms-reply-template/{id}','SMSController@manageSmsReplyTemplate');
Route::post('sms/post-manage-sms-reply-template','SMSController@postManageSmsReplyTemplate');
Route::get('sms/delete-sms-reply-template/{id}','SMSController@deleteSmsReplyTemplate');

//======================================================================
// SMS Auto Tags
//======================================================================
Route::get('sms/auto-tags','SMSController@autoTags');
Route::get('sms/create-auto-tags','SMSController@createAutoTags');
Route::post('sms/post-auto-tags','SMSController@postAutoTags');
Route::get('sms/manage-auto-tags/{id}','SMSController@manageAutoTags');
Route::post('sms/post-manage-auto-tags','SMSController@postManageAutoTags');
Route::get('sms/delete-auto-tags/{id}','SMSController@deleteAutoTags');
...
Route::any('sms/delivery-report-signalwire','PublicAccessController@deliverySignalwire');
...
// SMS Reply Templates
//======================================================================
Route::get('user/sms/sms-reply-templates','UserSMSController@smsReplyTemplates');
Route::get('user/sms/create-sms-reply-template','UserSMSController@createSmsReplyTemplate');
Route::post('user/sms/post-sms-reply-template','UserSMSController@postSmsReplyTemplate');
Route::get('user/sms/manage-sms-reply-template/{id}','UserSMSController@manageSmsReplyTemplate');
Route::post('user/sms/post-manage-sms-reply-template','UserSMSController@postManageSmsReplyTemplate');
Route::get('user/sms/delete-sms-reply-template/{id}','UserSMSController@deleteSmsReplyTemplate');

//======================================================================
// SMS Auto Tags
//======================================================================
Route::get('user/sms/auto-tags','UserSMSController@autoTags');
Route::get('user/sms/create-auto-tags','UserSMSController@createAutoTags');
Route::post('user/sms/post-auto-tags','UserSMSController@postAutoTags');
Route::get('user/sms/manage-auto-tags/{id}','UserSMSController@manageAutoTags');
Route::post('user/sms/post-manage-auto-tags','UserSMSController@postManageAutoTags');
Route::get('user/sms/delete-auto-tags/{id}','UserSMSController@deleteAutoTags');
...
Route::post('user/sms/bulk-campaign-assign','UserSMSController@assignBulkCampaign');
Route::get('user/sms/delete-campaign/{id}','UserSMSController@deleteCampaign');
Route::get('user/sms/start-campaign/{id}','UserSMSController@startCampaign');

// Route::get('user/sms/delete-campaign/{id}','UserSMSController@deleteCampaign');
Route::get('user/sms/pause-campaign/{id}','UserSMSController@pauseCampaign');
Route::get('user/sms/resume-campaign/{id}','UserSMSController@resumeCampaign');
...
Route::post('sms/add-chat-tag','ReportsController@addChatTag');
Route::post('sms/remove-chat-tag','ReportsController@removeChatTag');
...
Route::post('user/sms/add-chat-tag','UserSMSController@addChatTag');
Route::post('user/sms/remove-chat-tag','UserSMSController@removeChatTag');
...
Route::any('user/sms/phone-number','UserSMSController@phoneNumber');
Route::post('user/sms/post-phone-number','UserSMSController@postPhoneNumber');
Route::get('user/sms/get-phone-number/{number}','UserSMSController@getPhoneNumber');
