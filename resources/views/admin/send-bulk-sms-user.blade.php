                ...
                <div class="col-lg-6">
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <form class="" role="form" method="post" action="{{url('sms/post-bulk-sms-user')}}" enctype="multipart/form-data">
                                {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    <label>User</label>
                                    <select class="selectpicker form-control sender_id" name="send_id"
                                            data-live-search="true">
                                        @foreach($sender_id as $key => $si)
                                            <option value="{{$key}}">{{$si}}</option>
                                        @endforeach
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="selectpicker form-control" name="contact_type" id="contact_type">
                                        ...
                                        <option value="client_group">User Group</option>
                                    </select>
                                </div>
