...
<nav id="left-nav" class="left-nav-bar">
    ...
    <div class="nav-bottom-sec">
        <ul class="left-navigation" id="left-navigation">
            ...
            <li @if(Request::path()== 'user/sms/phone-number') class="active" @endif><a href={{url('user/sms/phone-number')}}><span class="menu-text">Get Number</span> <span class="menu-thumb"><i class="fa fa-user-secret"></i></span></a></li>
            ...
            <li @if(Request::path()=='user/sms/sms-reply-templates' OR Request::path()=='user/sms/create-sms-reply-template' OR Request::path()=='user/sms/manage-sms-reply-template/'.view_id()) class="active" @endif><a href={{url('user/sms/sms-reply-templates')}}><span class="menu-text">Quick Reply</span> <span class="menu-thumb"><i class="fa fa-file-code-o"></i></span></a></li>

            <li @if(Request::path()=='user/sms/auto-tags' OR Request::path()=='user/sms/create-auto-tags' OR Request::path()=='user/sms/manage-auto-tags/'.view_id()) class="active" @endif><a href={{url('user/sms/auto-tags')}}><span class="menu-text">Auto Tag</span> <span class="menu-thumb"><i class="fa fa-file-code-o"></i></span></a></li>
