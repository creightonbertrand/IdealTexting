                        ...
                        <div class="panel-body">
                            ...
                            <form class="" role="form" method="post" action="{{url('user/sms/post-bulk-sms')}}"
                                    ...
                                    @if($sender_ids)
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control sender_id" name="sender_id"
                                                    data-live-search="true">
                                                    <option value="">Rotate through Numbers</option>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Send x messages</label>
                                            <input type="number" min="1" name="amount" class="form-control" placeholder="1" value="1" />
                                        </div>
                                    </div>

                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Every x Seconds</label>
                                            <input type="number" min="1" name="intaval" class="form-control" placeholder="1" value="1" />
                                        </div>
                                    </div>
                                  ...
                                  <!-- Prince Awesome -->
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>Pause for x seconds</label>
                                                <input type="number" min="1" class="form-control" name="msg_pause_time" value="1">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label>After x Messages</label>
                                                <input type="number" min="1" class="form-control" name="msg_pause" value="1">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control time_picker" name="start_time" value="09:00 AM">
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label>Stop Time</label>
                                            <input type="text" class="form-control time_picker" name="stop_time" value="09:00 PM">
                                        </div>
                                    </div>
                                </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            　　format: "hh:mm A", //Hours and minutes hh: 24 hour format, HH: 12 hour format
            });
