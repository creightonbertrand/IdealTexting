                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="selectpicker form-control" name="keyword[]" data-live-search="true" multiple @if($campaign->status == 'Delivered') disabled @endif()>
                                        ...
                                        @if(app_config('sender_id_verification') == 1)
                                            @if($sender_ids)
                                                <div class="form-group">
                                                    ...
                                                    <select class="selectpicker form-control sender_id" name="sender" data-live-search="true" @if($campaign->status == 'Delivered') disabled @endif()>
                                                        @foreach($sender_ids as $si)
                                                            <option value="{{$si}}" @if($campaign->sender == $si) selected @endif()>{{$si}}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            @else
                                        ...
                                        @else
                                            <div class="form-group">
                                                <label>{{language_data('Sender ID',Auth::guard('client')->user()->lan_id)}}</label>
                                                <input type="text" class="form-control sender_id" value="{{$campaign->sender}}" name="sender_id" @if($campaign->status == 'Delivered') disabled @endif()>
                                            </div>
                                        @endif

                                        <div class="form-group">
                                            <label>{{language_data('Message')}}</label>
                                            <textarea class="form-control" name="message" rows="5" id="message" @if($campaign->status == 'Delivered') disabled @endif()>{{$campaign->message}}</textarea>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-5">
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon1">Send</span>
                                                    <input type="number" min="1" name="amount" class="form-control" placeholder="1" value="{{$campaign->amount}}" aria-describedby="basic-addon1" @if($campaign->status == 'Delivered') disabled @endif()>
                                                  </div>
                                            </div><!-- /.col-lg-6 -->
                                            <div class="col-lg-2">
                                                <span>Every</span>
                                            ...
                                            <div class="col-lg-5">
                                                <div class="input-group">
                                                    <input type="number" min="1" name="intaval" class="form-control" placeholder="1" value="{{$campaign->intaval}}" aria-describedby="basic-addon2" @if($campaign->status == 'Delivered') disabled @endif()>
